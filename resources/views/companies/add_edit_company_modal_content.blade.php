<div class="card">
    ...
    <div class="card-body">
        <!--begin::Form-->
        <form id="add_edit_company_form" class="form"
            action="{{ isset($edit_comp_details) && $edit_comp_details == true ? url('/company/edit') . '/' . (isset($comp_details->id) ? $comp_details->id : '') : url('/company/add_new') }}"
