...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true"
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted"><a
                                                href="{{ url('/master_application') . (isset($prev_page_id) ? '/' . $prev_page_id : '') }}"
                                                class="text-muted text-hover-primary">Applications</a></li>
                                        <!--end::Item-->
                                        @yield('breadcrumb')
                                    </ul>
                                    <!--end::Breadcrumb-->
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <div class="card-header border-0 pt-6">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="d-flex justify-content-end"
                                                ...
                                                {{-- <a href="{{ url('/application/add_new') }}" class="btn btn-primary"
                                                    style="margin-right: 10px;"><i
                                                        class="ki-duotone ki-plus fs-2"></i>Add application</a> --}}
                                                <a href="" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#addApplicationModal" id="openAddApplicationModal">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5"
                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                @foreach ($master_application as $key => $val)
                                                    <tr>
                                                        <td>
                                                            <div
                                                        ...
                                                        <td>
                                                            <p
                                                                class="view_application text-gray-800 text-hover-primary mb-1">
                                                                {{ isset($val['app_name']) ? $val['app_name'] : '-' }}
                                                            </p>
                                                        </td>
                                                        <td>
                                                            <p
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href=""
                                                                        class="menu-link px-3 edit_application"
                                                                        data-toggle="modal"
                                                                        data-target="#editApplicationModal"
                                                                        data-app-id="{{ isset($val['id']) ? $val['id'] : '' }}">
                                                                        Edit
                                                                    </a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item px-3">
                                                                    <a href="{{ route('delete_master_app', ['app_id' => $val['id']]) }}"
                                                                        data-id="{{ $val['id'] }}"
                                ...
                                <div class="modal fade" id="editApplicationModal" tabindex="-1"
                                    aria-labelledby="editApplictionModalLabel" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                    <div class="modal-dialog modal-dialog-centered mw-1000px">
                                        <!--begin::Modal content-->
                                        <div class="modal-content">
                                ...
                                <div class="modal fade" id="kt_modal_view_application" tabindex="-1"
                                    aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                    <div class="modal-dialog modal-dialog-centered mw-1000px">
                                        <!--begin::Modal content-->
                                        <div class="modal-content">
                                            <!--begin::Modal header-->
                                            <div class="modal-body" id="kt_modal_view_application_scroll">
                                                <h2 class="fw-bold">Application Details</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div id="kt_modal_close_view_application"
    ...
    <script>
        document.getElementById('openAddApplicationModal').addEventListener('click', function(event) {
            ...
            $.ajax({
                url: "{{ url('/master_application/add') }}",
                method: 'GET',
                dataType: 'html',
    ...
    <script>
        $(document).on('click', '.edit_application', function(event) {
            ...
            $.ajax({
                url: "{{ url('/master_application/edit') }}/" + app_id,
                method: 'GET',
                dataType: 'html',
                success: function(data) {
                    // Set the modal content with the fetched data
